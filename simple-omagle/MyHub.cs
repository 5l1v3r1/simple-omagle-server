...
namespace CoreApiDenemesi
{
    public class MyHub : Hub<ITypedHubClient>
    {
        ...
        public void biriyayinbaslatti(object gelenveri)
        {
            Clients.All.gotMessageFromServer(gelenveri);
        }
        ...
        public User GetUser()
        {
            ...
            while(Users[index].ConnectionId==Context.ConnectionId)
            {
        ...
        {
            var matchingCall =
                UserCalls.FirstOrDefault(uc => uc.Users.FirstOrDefault(u => u.ConnectionId == connectionId) != null);
            return matchingCall;
        }
